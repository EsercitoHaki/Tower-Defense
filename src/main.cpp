...
//     SDL_Texture* treeTexture  = loadTexture("assets/Tree.png", renderer);
...
//     SDL_FRect treeRect  = { 250, 150, 192, 192 };
...
//         SDL_RenderTexture(renderer, treeTexture, NULL, &treeRect);
...
int main(int argc, char* argv[]) {
    ...
    if (!game.Init("SDL3 OOP Game", 800, 600)) {
        return -1;
    }
